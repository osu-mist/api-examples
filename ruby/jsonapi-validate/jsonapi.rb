#----------------------------------------------------------
# Intro:   jsonapi gem is a tools for handling JSON API documents; it's also the most popular jsonapi gem
# Install: gem install jsonapi --pre
# Fixes:   need to remove Null links from links object
# Link: https://rubygems.org/gems/jsonapi
#----------------------------------------------------------
require 'jsonapi'
